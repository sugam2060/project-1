  ...
  return (
    <div className="py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        <Link
          href={"/products"}
          className="block bg-[#151515]/5 border border-[#151515]/20 text-center py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-[#151515] hover:bg-[#151515] hover:text-white hoverEffect"
        >
          Discover Products
        </Link>
      </motion.div>
