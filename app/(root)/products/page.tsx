...
const MainProductPage = async ({searchParams}:props) => {
    ...
    <Container className=''>
      <div className="pt-6 pb-1 px-4">
        <div className='space-y-0 flex flex-col items-center justify-center mb-6'>
          ...
          <ProductGrid limit={8} filter={category} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center gap-3" />
      </div>
    </Container>
  )
}
